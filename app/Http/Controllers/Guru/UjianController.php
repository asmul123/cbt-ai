...
class UjianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('guru.ujian.soal', $ujian)->with('success', 'Ujian berhasil dibuat. Silakan pilih soal.');
    }
    ...
    public function soal(Ujian $ujian)
    {
        ...
        return view('guru.ujian.soal', compact('ujian', 'soalTersedia'));
    }
    ...
    public function soalSync(Request $request, Ujian $ujian)
    {
        ...
        return redirect()->route('guru.ujian.index')->with('success', 'Soal ujian berhasil disimpan. Total: ' . count($request->soal_ids) . ' soal.');
    }
    ...
    public function publish(Ujian $ujian)
    {
        ...
        // Auto-generate peserta_ujian dengan distribusi ruang
    ...
    /**
     * Generate peserta ujian dari kelas terdaftar, ruang dari assignment admin
     */
